...
//---------------------- fetch del los productos y categoria-----------------------------------------------
function displayProducts(productsList) {
    let productsHTML = '';
    productsList.productos.forEach(element => {
...
window.onload = async () => {
    const response = await fetch(`https://api-bsale-test-ignacio.herokuapp.com/productos`);
